...
% use the expe_create_control_select.m or expe_create_control_ID_select.m 
% function to create a control law % function to be used in LabView. The 
% control law function is saved in % save_runs/tmp/.
%
